...
- Empty shopping cart
- Inventory management using ArrayList
- Shopping cart management using ArrayList
- Sort products in ascending order
- Sort products in descending order
- Product comparison using Comparable
- JSON file persistence for inventory
- Administration Application
- Client-server network communication
- Background administration server thread
