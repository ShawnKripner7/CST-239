...
public class StoreFront {
	...
	public void purchaseProduct(SalableProduct product) {
		...
		SalableProduct cartProduct = createCartProduct(product);
	...
	/**
	 * Cancels a purchase and returns one unit to inventory.
	 * 
	...
	public void cancelPurchase(SalableProduct product) {
		...
		if (shoppingCart.removeProduct(product)) {
			...
			SalableProduct inventoryProduct =
					findInventoryProduct(product.getName());

			if (inventoryProduct != null) {
				inventoryProduct.setQuantity(
						inventoryProduct.getQuantity() + 1);
			}
	...
	/**
	 * Empties the shopping cart and restores each product to inventory.
	 */
	...
	/**
	 * Creates a quantity-one product copy for the shopping cart.
	 * 
	 * @param product the inventory product
	 * @return a new product for the shopping cart
	 */
	 ...
	 * @return the matching inventory product, or null
	 */
	...
	public void displayInventory() {
		...
		for (int i = 0; i < inventory.length; i++) {
			...
			if (inventory[i] != null) {
				...
				displaySpecializedDetails(inventory[i]);
			}
		}
	}

	/**
	 * Displays information unique to a specialized product.
	 * 
	...
	/**
	 * Reads an integer without crashing on invalid input.
	 * 
	...
	/**
	 * Displays the store menu and processes user selections.
	 */
